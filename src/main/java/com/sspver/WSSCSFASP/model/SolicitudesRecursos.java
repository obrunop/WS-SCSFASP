...
public class SolicitudesRecursos implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "solicitudesRecursos")
    private Collection<DictamenesSolicitud> dictamenesSolicitudCollection;

    public SolicitudesRecursos() {
    }

    public SolicitudesRecursos(Integer solicitudId) {
        this.solicitudId = solicitudId;
    }

    public SolicitudesRecursos(Integer solicitudId, Date fechaElaboracion, String noTramite, short sonHonorarios, String cuentaContable, short aplicada) {
        this.solicitudId = solicitudId;
    ...
    public EstadoSolicitudes getFkEstado() {
        return fkEstado;
    }

    public void setFkEstado(EstadoSolicitudes fkEstado) {
        this.fkEstado = fkEstado;
    }

    public Firmas getFkFirmaSolicita() {
        return fkFirmaSolicita;
    }

    public void setFkFirmaSolicita(Firmas fkFirmaSolicita) {
        this.fkFirmaSolicita = fkFirmaSolicita;
    }

    public Firmas getFkfirmaVB() {
        return fkfirmaVB;
    }

    public void setFkfirmaVB(Firmas fkfirmaVB) {
        this.fkfirmaVB = fkfirmaVB;
    }

    public Firmas getFkFirmaAutoriza() {
        return fkFirmaAutoriza;
    }

    public void setFkFirmaAutoriza(Firmas fkFirmaAutoriza) {
        this.fkFirmaAutoriza = fkFirmaAutoriza;
    }

    public Usuarios getFkUsuarioCrea() {
        return fkUsuarioCrea;
    }

    public void setFkUsuarioCrea(Usuarios fkUsuarioCrea) {
        this.fkUsuarioCrea = fkUsuarioCrea;
    }

    public Usuarios getFkUsuarioActualiza() {
        return fkUsuarioActualiza;
    }

    public void setFkUsuarioActualiza(Usuarios fkUsuarioActualiza) {
        this.fkUsuarioActualiza = fkUsuarioActualiza;
    }

    public Collection<PedidosSolicitudes> getPedidosSolicitudesCollection() {
        return pedidosSolicitudesCollection;
    }

    public void setPedidosSolicitudesCollection(Collection<PedidosSolicitudes> pedidosSolicitudesCollection) {
        this.pedidosSolicitudesCollection = pedidosSolicitudesCollection;
    }

    public Collection<SolicitudesHonorarios> getSolicitudesHonorariosCollection() {
        return solicitudesHonorariosCollection;
    }

    public void setSolicitudesHonorariosCollection(Collection<SolicitudesHonorarios> solicitudesHonorariosCollection) {
    ...
    public Collection<DictamenesSolicitud> getDictamenesSolicitudCollection() {
        return dictamenesSolicitudCollection;
    }

    public void setDictamenesSolicitudCollection(Collection<DictamenesSolicitud> dictamenesSolicitudCollection) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SolicitudesRecursos)) {
            return false;
        }
        SolicitudesRecursos other = (SolicitudesRecursos) object;
