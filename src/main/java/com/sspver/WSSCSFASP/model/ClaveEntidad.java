...
public class ClaveEntidad implements Serializable {
    ...
    public ClaveEntidad(Integer claveId) {
        this.claveId = claveId;
    }

    public ClaveEntidad(Integer claveId, String claveE, String claveI) {
        this.claveId = claveId;
        this.claveE = claveE;
        this.claveI = claveI;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ClaveEntidad)) {
            return false;
        }
        ClaveEntidad other = (ClaveEntidad) object;
