...
public class MontosAdecuaciones implements Serializable {
    ...
    @ManyToOne
    private DetallesEstructuras fkDetalleEstructura;
    @JoinColumn(name = "fk_tipo_adecuacion", referencedColumnName = "tipo_adecuacion_id")
    @ManyToOne
    private TipoAdecuacion fkTipoAdecuacion;

    public MontosAdecuaciones() {
    }

    public MontosAdecuaciones(Integer historialId) {
        this.historialId = historialId;
    }

    public MontosAdecuaciones(Integer historialId, BigDecimal faspFederal, BigDecimal faspMunicipal, BigDecimal aportacionEstatal, BigDecimal aportacionMunicipal, int cantidadFed, int personaFed) {
        this.historialId = historialId;
    ...
    public DetallesEstructuras getFkDetalleEstructura() {
        return fkDetalleEstructura;
    }

    public void setFkDetalleEstructura(DetallesEstructuras fkDetalleEstructura) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MontosAdecuaciones)) {
            return false;
        }
        MontosAdecuaciones other = (MontosAdecuaciones) object;
