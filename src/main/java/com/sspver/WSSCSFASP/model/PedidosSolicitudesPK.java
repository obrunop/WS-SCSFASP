 ...
 */
@Embeddable
public class PedidosSolicitudesPK implements Serializable {
    ...
    public PedidosSolicitudesPK() {
    }

    public PedidosSolicitudesPK(String pedido, int fkSolicitudId) {
        this.pedido = pedido;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PedidosSolicitudesPK)) {
            return false;
        }
        PedidosSolicitudesPK other = (PedidosSolicitudesPK) object;
