...
public class Conceptos implements Serializable {
    ...
    private Collection<PartidasGenericas> partidasGenericasCollection;
    ...
    public Conceptos(Integer conceptoId, String nombreConcepto) {
        this.conceptoId = conceptoId;
    ...
    public Collection<PartidasGenericas> getPartidasGenericasCollection() {
        return partidasGenericasCollection;
    }

    public void setPartidasGenericasCollection(Collection<PartidasGenericas> partidasGenericasCollection) {
