...
public class Eje implements Serializable {
    ...
    private Collection<Programa> programasCollection;

    public Eje() {
    }

    public Eje(Integer ejeId) {
        this.ejeId = ejeId;
    }

    public Eje(Integer ejeId, String claveEje, String nombreEje) {
        this.ejeId = ejeId;
    ...
    public Collection<Programa> getProgramasCollection() {
        return programasCollection;
    }

    public void setProgramasCollection(Collection<Programa> programasCollection) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Eje)) {
            return false;
        }
        Eje other = (Eje) object;
