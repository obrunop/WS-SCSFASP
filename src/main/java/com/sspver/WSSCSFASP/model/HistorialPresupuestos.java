...
public class HistorialPresupuestos implements Serializable {
    ...
    private Presupuestos fkPresupuestoId;

    public HistorialPresupuestos() {
    }

    public HistorialPresupuestos(Integer historialPtoId) {
        this.historialPtoId = historialPtoId;
    }

    public HistorialPresupuestos(Integer historialPtoId, Date fecha, BigDecimal faspFederal, BigDecimal faspMunicipal, BigDecimal aportacionEstatal, BigDecimal aportacionMunicipal) {
        this.historialPtoId = historialPtoId;
        this.fecha = fecha;
    ...
    public Presupuestos getFkPresupuestoId() {
        return fkPresupuestoId;
    }

    public void setFkPresupuestoId(Presupuestos fkPresupuestoId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HistorialPresupuestos)) {
            return false;
        }
        HistorialPresupuestos other = (HistorialPresupuestos) object;
