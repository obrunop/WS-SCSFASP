...
public class Presupuestos implements Serializable {
    ...
    private Collection<HistorialPresupuestos> historialPresupuestosCollection;
    @JoinColumn(name = "fk_detalle_ep", referencedColumnName = "detalle_id")
    @ManyToOne(optional = false)
    private DetallesEstructuras fkDetalleEp;
    ...
    public Presupuestos(Integer presupuestoId) {
        this.presupuestoId = presupuestoId;
    }

    public Presupuestos(Integer presupuestoId, BigDecimal faspFederal, BigDecimal faspMunicipal, BigDecimal aportacionEstatal, BigDecimal aportacionMunicipal) {
        this.presupuestoId = presupuestoId;
    ...
    public Collection<HistorialPresupuestos> getHistorialPresupuestosCollection() {
        return historialPresupuestosCollection;
    }

    public void setHistorialPresupuestosCollection(Collection<HistorialPresupuestos> historialPresupuestosCollection) {
        this.historialPresupuestosCollection = historialPresupuestosCollection;
    }

    public DetallesEstructuras getFkDetalleEp() {
        return fkDetalleEp;
    }

    public void setFkDetalleEp(DetallesEstructuras fkDetalleEp) {
