 ...
 */
@Embeddable
public class DictamenesSolicitudPK implements Serializable {
    ...
    public DictamenesSolicitudPK() {
    }

    public DictamenesSolicitudPK(String dsp, int fkSolicitudId) {
        this.dsp = dsp;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DictamenesSolicitudPK)) {
            return false;
        }
        DictamenesSolicitudPK other = (DictamenesSolicitudPK) object;
